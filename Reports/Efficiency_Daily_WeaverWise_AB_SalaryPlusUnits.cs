...
{
    public partial class Efficiency_Daily_WeaverWise_AB_SalaryPlusUnits : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        double Salary_FixedWage = 0;
        double Salary_WagePerUnit=0;
        double Salary_WeaversUnits=0;
        double Salary_UnitsWage = 0;
        double Salary_TotalWage = 0;
        public Efficiency_Daily_WeaverWise_AB_SalaryPlusUnits()
        {
            InitializeComponent();
        }
        ...
        private void WagePerUnit_AfterPrint(object sender, EventArgs e)
        {
            XRLabel xr=(XRLabel)sender;
            double.TryParse(xr.Text, out Salary_WagePerUnit);
            Salary_UnitsWage = Salary_WagePerUnit * Salary_WeaversUnits;
            this.UnitWage.Text = Salary_UnitsWage.ToString("#,##");
            Salary_TotalWage = Salary_FixedWage + Salary_UnitsWage;
            this.TotalWage.Text = Salary_TotalWage.ToString("#,##");
            Salary_FixedWage = 0;
            Salary_TotalWage = 0;
            Salary_UnitsWage = 0;
            Salary_WagePerUnit = 0;
            Salary_WeaversUnits = 0;
        }
        ...
        private void FixedWage_AfterPrint(object sender, EventArgs e)
        {
            XRLabel xr = (XRLabel)sender;
            if(xr.Tag!=null)
                double.TryParse(xr.Tag.ToString(), out Salary_FixedWage);
        }

   

        private void xr_T_Units_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            double thisUnits = 0;
            XRLabel xr = (XRLabel)sender;
            double.TryParse(xr.Text.ToString(), out thisUnits);
            Salary_WeaversUnits += thisUnits;
        }
