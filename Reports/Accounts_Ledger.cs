...
{
    public partial class Accounts_Ledger : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void xr_DocNumber_PreviewDoubleClick(object sender, PreviewMouseEventArgs e)
        {
            if (e.Brick != null)
            {
                if (e.Brick.TextValue != null)
                {
                    MachineEyes.Classes.Accounting.Print_DetectVoucherType(e.Brick.TextValue.ToString());
                }
            }
        }
