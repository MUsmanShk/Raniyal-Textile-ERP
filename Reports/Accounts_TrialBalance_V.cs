...
{
    public partial class Accounts_TrialBalance_V : DevExpress.XtraReports.UI.XtraReport
    {
        Int64 GroupDebit = 0; Int64 GroupCredit = 0;
        Int64 TDebit = 0; Int64 TCredit = 0;
        int indexno = 0;
        public Accounts_TrialBalance_V()
        {
            InitializeComponent();
        }

        private void eDebit_AccountsV_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
        ...
        private void eCredit_AccountsV_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            XRLabel xr = (XRLabel)sender;
            int credit = 0;
            if (xr.Tag != null)
