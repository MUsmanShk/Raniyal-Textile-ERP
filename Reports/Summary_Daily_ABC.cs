...
{
    public partial class Summary_Daily_ABC: DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public Summary_Daily_ABC()
        {
            InitializeComponent();
        }

        private void ConvertoMMSS(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
        ...
        private void Mechanical_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                double LongTimings = 0;
                double.TryParse(xr.Tag.ToString(), out LongTimings);
                if (LongTimings > 0)
                {
                    TimeSpan ts = new TimeSpan(0, 0, Convert.ToInt32(LongTimings));
                    xr.Text = Program.ss.Get_FormattedTime(ts, (int)TimeFormats.HHMM);
