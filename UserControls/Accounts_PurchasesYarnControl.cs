...
{
    public partial class Accounts_PurchasesYarnControl : DevExpress.XtraEditors.XtraUserControl
    {
        public MachineEyes.Classes.easyPurchasesCalculations eVC;
        public string SupplierID = "";
        public Accounts_PurchasesYarnControl()
        {
            InitializeComponent();
        ...
        private void TakeAction(KeyEventArgs e)
        {
            ...
            {
                Accounts_PurchasesYarnControl nAccount = new Accounts_PurchasesYarnControl();
        ...
        public void Calculations()
        {
            ...
            if (this.Parent != null)
            {
                ...
                {
                    Accounts_PurchasesYarnControl te = (Accounts_PurchasesYarnControl)c;
        ...
        private void AccountID_KeyPress(object sender, KeyPressEventArgs e)
        {

        }

        private void Counts_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void Ply_KeyUp(object sender, KeyEventArgs e)
        {
            LookUpEdit l = (LookUpEdit)sender;
            if (e.KeyCode == Keys.Delete)
                l.EditValue = null;
        ...
        private void Blends_KeyUp(object sender, KeyEventArgs e)
        {
            LookUpEdit l = (LookUpEdit)sender;
            if (e.KeyCode == Keys.Delete)
                l.EditValue = null;
