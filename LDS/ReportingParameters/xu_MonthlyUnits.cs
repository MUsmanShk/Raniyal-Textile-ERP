...
{
    public partial class xu_MonthlyUnits : DevExpress.XtraEditors.XtraUserControl
    {
        public xu_MonthlyUnits()
        {
            InitializeComponent();
        }

        private void xu_MonthlyUnits_Load(object sender, EventArgs e)
        {
        ...
        private void PrintReport_Click(object sender, EventArgs e)
        {
            ...
            Reports.Efficiency_MonthlyUnitsSummary ABC = new Reports.Efficiency_MonthlyUnitsSummary();
