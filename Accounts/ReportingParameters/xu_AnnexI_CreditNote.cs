...
{
    public partial class xu_AnnexI_CreditNote : DevExpress.XtraEditors.XtraUserControl
    {
        public xu_AnnexI_CreditNote()
        {
            InitializeComponent();
        }
        ...
        {
            Reports.Accounts_AnnexI_CreditNote AnnexI = new Reports.Accounts_AnnexI_CreditNote();
        ...
        private void xu_AnnexI_CreditNote_Load(object sender, EventArgs e)
        {
