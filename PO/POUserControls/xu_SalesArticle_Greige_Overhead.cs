...
{
    public partial class xu_SalesArticle_Greige_Overhead : DevExpress.XtraEditors.XtraUserControl
    {
        public xu_SalesArticle_Greige_Overhead()
        {
            InitializeComponent();
        }
        ...
        private void CalculatePrice()
        {
            ...
            if (this.QuantityMtrs.EditValue != null)
                ...
                dTotalMeters = 0;
            if (this.WeavingRatePerMeter.EditValue != null)
                double.TryParse(this.WeavingRatePerMeter.EditValue.ToString(), out dRatePerMeter);
            else
                dRatePerMeter = 0;
