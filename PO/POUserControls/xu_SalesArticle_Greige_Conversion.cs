...
{
    public partial class xu_SalesArticle_Greige_Conversion : DevExpress.XtraEditors.XtraUserControl
    {
        public xu_SalesArticle_Greige_Conversion()
        {
            InitializeComponent();
        }
        ...
        private void CalculatePrice()
        {
            ...
            if (this.QuantityMtrs.EditValue != null)
                ...
                dTotalMeters = 0;
            if (this.PriceConversionPerMeter.EditValue != null)
                double.TryParse(this.PriceConversionPerMeter.EditValue.ToString(), out dRatePerMeter);
            else
                dRatePerMeter = 0;
