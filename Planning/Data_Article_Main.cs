...
{
    public partial class Data_Article_Main : DevExpress.XtraEditors.XtraForm
    {
       
        enum UserInputMode { View = 0, Add = 1, Edit = 2, Delete = 3 };
        UserInputMode uiMode;
        public Data_Article_Main()
        {
            InitializeComponent();
        }
        ...
        private void dxData_Article_Load(object sender, EventArgs e)
        {
            ...
            fc.MeasurementUnits(ref SellingUnit);
        ...
        private void Update_Article()
        {
            ...
            query+=",PPI='" + this.Article_PPI_textEdit.Text + "'";
             ...
             if (this.SellingUnit.EditValue !=null)
                 query += ",SellingUnit='" + this.SellingUnit.EditValue.ToString() + "'";
             else
                 query += ",SellingUnit=null";
             if (this.FabricName.EditValue != null)
                 query += ",FabricName='" + this.FabricName.EditValue.ToString() + "'";
             else
                 query += ",FabricName=null";
             double sRate = 0;
             double.TryParse(this.SellingRate.Text, out sRate);
             query += ",SellingRate=" + sRate.ToString() + "";
        ...
        {
            //execute save query (save records into database)
            string query = "insert into PP_Article (articlenumber,articlename,ArticleShortName,FabricName,EPI,PPI,SellingUnit,SellingRate,Width,InsertionType,ArticleWeave,ArticleSelvage,GSM,TotalPicksFancy,TotalPicksBody,SizeWidth,SizeHeight,CMORINCHES,WeightGrams";
            ...
            if (CheckFancyTowel.Checked == true)
            {
                for (int x = 0; x < this.scroll_Pile.Controls.Count; x++)
                {
            ...
            if (this.SellingUnit.EditValue!=null)
                query += ",'" + this.SellingUnit.EditValue.ToString() + "'";
            else
                query += ",null";
            double SRate = 0;
            double.TryParse(this.SellingRate.Text, out SRate);
           
                query += "," + SRate.ToString() + "";
        ...
        private void Clear_Article()
        {
            ...
            this.SellingRate.Text = "";
            this.SellingUnit.EditValue = null;
           ...
           if (this.scroll_Pile.Controls.Count >= 1)
           {
               ...
               dxy.Ply.EditValue = null;
               dxy.PicksorEnds.Visible = false;
               this.CheckFancyTowel.Checked = true;
           }
           else
           {
               this.CheckFancyTowel.Checked = false;
        ...
        private void Make_Article()
        {
            ...
            if (this.CheckFancyTowel.Checked == true)
            {
            ...
            {
                Articlename += x == 0 ? "" : " + ";
                if (this.CheckFancyTowel.Checked == false) { ArticleShortName += x == 0 ? "" : " + "; }
                dxYarnCountTwistBlend dytb =(dxYarnCountTwistBlend) this.scroll_Warp.Controls[x];
                try
                {
                    if (dytb.Counts.EditValue != null)
                ...
                if (this.CheckFancyTowel.Checked == false)
                {
                    if (Ply != "")
                    {
                        if (Ply != "1")
            ...
            if (CheckFancyTowel.Checked == true)
            {
                ...
                if (this.CheckFancyTowel.Checked == false) ArticleShortName += " * ";
                for (int x = 0; x < this.scroll_Pile.Controls.Count; x++)
                {
                    Articlename += x == 0 ? "" : " + ";
                    if (this.CheckFancyTowel.Checked == false)
            ...
            if (this.Article_PPI_textEdit.Text != "" && this.Article_EPI_textEdit.Text != "")
            {
                ...
                if (this.CheckFancyTowel.Checked == false) ArticleShortName += " /  " + this.Article_EPI_textEdit.Text + " x " + this.Article_PPI_textEdit.Text;
            }
            if (this.Article_Width_textEdit.Text != "")
            {
                Articlename += " = " + this.Article_Width_textEdit.Text + "`` ";
                if (this.CheckFancyTowel.Checked == false) ArticleShortName += " = " + this.Article_Width_textEdit.Text + "`` ";

            }
            if (this.FabricName.EditValue != null)
            {
                Articlename += "  " + this.FabricName.EditValue.ToString();
                if (this.CheckFancyTowel.Checked == false) ArticleShortName += "  " + this.FabricName.EditValue.ToString();
            ...
            else
            {
                ...
                {
                    if (pBlend != "")
                        if (this.CheckFancyTowel.Checked == false) ArticleShortName += "  " + pBlend;
                }
            }
            if(this.Article_Weave_comboBoxEdit.EditValue!=null)
        ...
        private void btn_View_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Clear_Article();
                    this.Article_Number_textEdit.Tag = Program.MainWindow.ArticleView.SelectedRow.PrimeryID;
                    this.Article_Number_textEdit.Text = Program.MainWindow.ArticleView.SelectedRow.PrimeryID;
                    this.Article_Details_Label.Tag = Program.MainWindow.ArticleView.SelectedRow.PrimaryString;
                    ...
                    try
                    {
                        ...
                        this.SellingUnit.EditValue = ds.Tables[0].Rows[0]["SellingUnit"].ToString();
                        this.SellingRate.Text = ds.Tables[0].Rows[0]["Sellingrate"].ToString();
        ...
        private void CheckFancyTowel_CheckedChanged(object sender, EventArgs e)
        {
            if (CheckFancyTowel.Checked == true)
            {
                Add_Pile.Enabled = true;
                Less_Pile.Enabled = true;
            }
            else
            {
                Add_Pile.Enabled = false;
                Less_Pile.Enabled = false;
                scroll_Pile.Controls.Clear();
                Make_Article();
            }
        }
